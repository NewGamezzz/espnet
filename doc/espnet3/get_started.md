...
| Configure training          | `conf/train.yaml` (model, trainer, optimizer)    | [Optimizer configuration](./core/components/optimizer_configuration.md), [Callbacks](./core/components/callbacks.md) |
