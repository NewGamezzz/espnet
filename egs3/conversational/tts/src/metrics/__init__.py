...
dependencies (silero-vad, faster-whisper, WavLM, UTMOS, ...) are lazily
imported inside functions/constructors, never at module scope, so importing
this package stays CPU-only and network-free.
"""
